  ...
  if (smtg_getTeamPkDetailInfoRes && smtg_getTeamPkDetailInfoRes.data.bizCode === 0) {
    ...
    if (joinStatus === 0) {
      if (joinPkTeam === 'true') {
        ...
        await updatePkActivityIdCDN('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/jd_updateTeam.json');
...
async function bigWinner() {
  let res = await getAuthorShareCode2('https://raw.githubusercontent.com/asd920/updateTeam/main/shareCodes/bigWinner.json')
  if (!res) {
    $.http.get({url: 'https://purge.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/bigWinner.json'}).then((resp) => {}).catch((e) => $.log('刷新CDN异常', e));
    await $.wait(1000)
    res = await getAuthorShareCode2('https://cdn.jsdelivr.net/gh/asd920/updateTeam@main/shareCodes/bigWinner.json')
  }
